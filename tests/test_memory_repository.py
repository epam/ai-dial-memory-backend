...
from app.models.memory import MemoryRow
from app.storage.repository import LanceDbMemoryRepository
...
def test_append_creates_table_and_adds_row(settings: AppSettings) -> None:
    ...
    with patch("app.storage.repository.lancedb.connect", return_value=db):
